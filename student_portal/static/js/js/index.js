...
function websdkready() {
  ...
  var SDK_KEY = "qQoY7N9iAMW0Vs6j15AOusyq04YvI5asvPih";
  /**
   ...
   */
  var SDK_SECRET = "G0NqwRavXX9SF2HsK7cwQDkj3tGTG1qcYawE ";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://127.0.0.1:8000/inter/inter/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
  ...
  window.copyJoinLink = function (element) {
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        meetingConfig.signature = res.result;
        meetingConfig.sdkKey = SDK_KEY;
        var joinUrl = "http://127.0.0.1:8000/inter/inter/meeting.html?"
          testTool.getCurrentDomain() +
          "http://127.0.0.1:8000/inter/inter/meeting.html?" +
